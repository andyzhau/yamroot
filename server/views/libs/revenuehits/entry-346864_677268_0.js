!(function(e) {
  ...
  function(e, t, r) {
    ...
    var U = a.getInstance(),
      ...
      G = {
        cid: "346864_677268_0",
        prefix: "imgBanner20190412/20190415_362585300_",
        pid: "346864",
        redirurl: "",
        geo: "US",
        animType: "SHOW",
        size: "300x50",
        ap:
          "cmp=BANNER&evp=VpB4i-Ub_kllL6c1pz_is1Y37AsT2Aew4KQyKdWyBmWblvdFtoSSdUuuxtv_k0Xi&sjv=75.0&ctid=0"
      };
    try {
      isNaN("63902184168") ||
        W.cookie.get("rhid_c") ||
        ...
        (U.d.serverName["346864_677268_0"] = "mybestmv.com"),
        (U.d.betaClients = []),
...
(function() {
  ...
  if (!_$cmp[companionId]) {
    ...
    for (var i = scripts.length - 1; i >= 0; i--) {
      myScript = scripts[i];
      if (myScript.src.indexOf("tid=346864_677268_0") != -1) {
        found = true;
        break;
      }
    }
